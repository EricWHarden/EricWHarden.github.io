//============================================================================
// Name        : EricHarden_CS-260_HashTable.cpp
// Author      : Eric Harden
// Date        : 1/29/23
// Version     : 1.1
...
private:
    ...
    vector<Node> nodes;
    //Declares tableSize as type unsigned with value of DEFAULT_SIZE
    unsigned tableSize = DEFAULT_SIZE;
    //Declare hash integer with key parameter
...
/**
* New function to see if hash table is empty
*/

bool HashTable::isEmpty() const {
    int sum{};
    for (int i{}; i < DEFAULT_SIZE; i++) {
        sum += tableSize[i].size();
    }
...
Bid HashTable::Search(string bidId) {
    ...
    //Walk linked-list to find the match
    while (node != nullptr) {
...
int main(int argc, char* argv[]) {
    ...
    if (bidTable->isEmpty()) {
        cout << "Table is awaiting entries." << endl;
    }
    else {
        cout << "Error. New table should be empty, check out code." << endl;
    }
